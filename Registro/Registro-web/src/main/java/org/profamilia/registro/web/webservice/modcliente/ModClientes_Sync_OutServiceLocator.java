/**
 * ModClientes_Sync_OutServiceLocator.java
 *
...
public class ModClientes_Sync_OutServiceLocator extends org.apache.axis.client.Service implements ModClientes_Sync_OutService {

    public ModClientes_Sync_OutServiceLocator() {
    }


    public ModClientes_Sync_OutServiceLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public ModClientes_Sync_OutServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for HTTPS_Port
    private java.lang.String HTTPS_Port_address = "https://profpiprd01.profamilia.org.co:52000/XISOAPAdapter/MessageServlet?senderParty=&senderService=SAP_I_CLINICO_BS&receiverParty=&receiverService=&interface=ModClientes_Sync_Out&interfaceNamespace=urn%3Amodcliente%3Aclinico%3Asap";
    ...
    public ModClientes_Sync_Out getHTTPS_Port(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ModClientes_Sync_OutBindingStub _stub = new ModClientes_Sync_OutBindingStub(portAddress, this);
    ...
    private java.lang.String HTTP_Port_address = "http://profpiprd01.profamilia.org.co:52000/XISOAPAdapter/MessageServlet?senderParty=&senderService=SAP_I_CLINICO_BS&receiverParty=&receiverService=&interface=ModClientes_Sync_Out&interfaceNamespace=urn%3Amodcliente%3Aclinico%3Asap";
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ModClientes_Sync_Out.class.isAssignableFrom(serviceEndpointInterface)) {
                ModClientes_Sync_OutBindingStub _stub = new ModClientes_Sync_OutBindingStub(new java.net.URL(HTTPS_Port_address), this);
                _stub.setPortName(getHTTPS_PortWSDDServiceName());
                return _stub;
            }
            if (ModClientes_Sync_Out.class.isAssignableFrom(serviceEndpointInterface)) {
                ModClientes_Sync_OutBindingStub _stub = new ModClientes_Sync_OutBindingStub(new java.net.URL(HTTP_Port_address), this);
                _stub.setPortName(getHTTP_PortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("urn:modcliente:clinico:sap", "ModClientes_Sync_OutService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("urn:modcliente:clinico:sap", "HTTPS_Port"));
            ports.add(new javax.xml.namespace.QName("urn:modcliente:clinico:sap", "HTTP_Port"));
        }
