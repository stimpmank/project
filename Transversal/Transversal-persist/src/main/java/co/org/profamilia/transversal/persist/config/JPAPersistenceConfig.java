...
public class JPAPersistenceConfig {
    ...
    private static final Logger logger = LoggerFactory.getLogger(JPAPersistenceConfig.class);
    ...
    public LocalContainerEntityManagerFactoryBean transversalEntityManagerFactory() {
        ...
        em.setPackagesToScan(new String[]{"co.org.profamilia"});
    ...
    @Autowired
    public PlatformTransactionManager transversalTransactionManager(
            @Qualifier("transversalEntityManagerFactory") EntityManagerFactory transversalEntityManagerFactory) {
