...
@Configuration
public class ProfamiliaWebConfig extends WebMvcConfigurationSupport {

    private static final Logger logger = LoggerFactory.getLogger(ProfamiliaWebConfig.class);
